...
CREATE TABLE "applications" (
  ...
  "credit_score_shared" smallint DEFAULT 0,
  "background_check_consent" smallint DEFAULT 0,
  "income_verification_consent" smallint DEFAULT 0,
...
('86ef02ea-a4d6-4f08-9a01-2c0b752868ef', 'f014ff7e-7722-49b1-ad63-72bea18f568f', '23cffaef-b163-402d-a4b4-bb7c3b9f4f41', '43f43baa-8cc9-468b-be2f-4f13d8aa39fa', 'approved', '2026-03-22 18:03:19', NULL, NULL, 12, '', NULL, 0, 0, 0, NULL, NULL, '2026-03-22 20:43:05', '43f43baa-8cc9-468b-be2f-4f13d8aa39fa', '2026-03-22 18:03:19', '2026-03-22 20:43:05'),
('918ce4ce-25b0-4317-b5be-633eb5326a03', 'f014ff7e-7722-49b1-ad63-72bea18f568f', '23cffaef-b163-402d-a4b4-bb7c3b9f4f41', '43f43baa-8cc9-468b-be2f-4f13d8aa39fa', 'under_review', '2026-03-22 17:59:40', NULL, NULL, 12, '', NULL, 0, 0, 0, NULL, NULL, '2026-03-22 20:40:24', '43f43baa-8cc9-468b-be2f-4f13d8aa39fa', '2026-03-22 17:59:40', '2026-03-22 20:40:24'),
('fad64d24-499c-4ce6-800b-6c6e555b1071', 'd8333370-9867-4157-8fb8-511a2073bc10', '23cffaef-b163-402d-a4b4-bb7c3b9f4f41', '43f43baa-8cc9-468b-be2f-4f13d8aa39fa', 'approved', '2026-03-22 22:26:28', NULL, NULL, 12, '', NULL, 0, 0, 0, NULL, NULL, '2026-03-22 22:38:03', '43f43baa-8cc9-468b-be2f-4f13d8aa39fa', '2026-03-22 22:26:28', '2026-03-22 22:38:03');
...
CREATE TABLE "credit_scores" (
  ...
  "credit_history_length_score" integer DEFAULT 0,
  "credit_mix_score" integer DEFAULT 0,
  "new_inquiries_score" integer DEFAULT 0,
  "score_rating" varchar(50) NOT NULL,
  "last_updated" timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
  "is_shared_with_landlord" smallint DEFAULT 0,
  "share_code" varchar(50) DEFAULT NULL,
  "share_code_expires_at" timestamp without time zone DEFAULT NULL,
  "created_at" timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE "leases" (
  ...
  "signed_by_tenant" smallint DEFAULT 0,
  "tenant_signed_at" timestamp without time zone DEFAULT NULL,
  "signed_by_landlord" smallint DEFAULT 0,
  "landlord_signed_at" timestamp without time zone DEFAULT NULL,
  "created_at" timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE "maintenance_requests" (
  ...
  "scheduled_date" timestamp without time zone DEFAULT NULL,
  "completed_date" timestamp without time zone DEFAULT NULL,
  "cost" decimal(10,2) DEFAULT NULL,
  "paid_by" varchar(50) DEFAULT NULL,
  "contractor_name" varchar(255) DEFAULT NULL,
  "contractor_phone" varchar(20) DEFAULT NULL,
  "landlord_notes" text DEFAULT NULL,
  "tenant_rating" integer DEFAULT NULL,
...
CREATE TABLE "notification_settings" (
  "id" integer NOT NULL,
  "user_id" varchar(36) NOT NULL,
  "new_applications" smallint DEFAULT 1,
  "payment_reminders" smallint DEFAULT 1,
  "maintenance_requests" smallint DEFAULT 1,
  "monthly_reports" smallint DEFAULT 0,
  "created_at" timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamp without time zone DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE "payments" (
  ...
  "paid_date" timestamp without time zone DEFAULT NULL,
...
CREATE TABLE "properties" (
  ...
  "currency" varchar(3) DEFAULT 'TZS',
  "security_deposit" decimal(12,2) DEFAULT NULL,
  "is_furnished" smallint DEFAULT 0,
...
CREATE TABLE "tenant_profiles" (
  ...
  "income_verified" smallint DEFAULT 0,
...
CREATE TABLE "verifications" (
  ...
  "nin_verified" smallint DEFAULT 0,
  "nin_verified_at" timestamp without time zone DEFAULT NULL,
  "bvn_number" varchar(20) DEFAULT NULL,
  "bvn_verified" smallint DEFAULT 0,
  "bvn_verified_at" timestamp without time zone DEFAULT NULL,
  "id_document_url" varchar(500) DEFAULT NULL,
  "id_document_type" varchar(50) DEFAULT NULL,
  "id_verified" smallint DEFAULT 0,
  "id_verified_at" timestamp without time zone DEFAULT NULL,
  "selfie_url" varchar(500) DEFAULT NULL,
  "selfie_verified" smallint DEFAULT 0,
  "address_verified" smallint DEFAULT 0,
...
CREATE INDEX "applications_idx_property" ON "applications" ("property_id");

CREATE INDEX "applications_idx_tenant" ON "applications" ("tenant_id");

CREATE INDEX "applications_idx_landlord" ON "applications" ("landlord_id");

CREATE INDEX "applications_idx_status" ON "applications" ("status");

ALTER TABLE "background_checks" ADD PRIMARY KEY ("id");

CREATE INDEX "background_checks_idx_user" ON "background_checks" ("user_id");

CREATE INDEX "background_checks_idx_type" ON "background_checks" ("check_type");

CREATE INDEX "background_checks_idx_status" ON "background_checks" ("status");

ALTER TABLE "credit_scores" ADD PRIMARY KEY ("id");

CREATE UNIQUE INDEX "credit_scores_unique_user_credit" ON "credit_scores" ("user_id");

CREATE UNIQUE INDEX "credit_scores_share_code" ON "credit_scores" ("share_code");

ALTER TABLE "documents" ADD PRIMARY KEY ("id");

CREATE INDEX "documents_idx_user" ON "documents" ("user_id");

CREATE INDEX "documents_idx_type" ON "documents" ("document_type");

ALTER TABLE "expenses" ADD PRIMARY KEY ("id");

CREATE INDEX "expenses_idx_landlord" ON "expenses" ("landlord_id");

CREATE INDEX "expenses_idx_property" ON "expenses" ("property_id");

CREATE INDEX "expenses_idx_date" ON "expenses" ("expense_date");

ALTER TABLE "favorites" ADD PRIMARY KEY ("id");

CREATE UNIQUE INDEX "favorites_unique_favorite" ON "favorites" ("user_id","property_id");

CREATE INDEX "favorites_property_id" ON "favorites" ("property_id");

ALTER TABLE "leases" ADD PRIMARY KEY ("id");

CREATE INDEX "leases_landlord_id" ON "leases" ("landlord_id");

CREATE INDEX "leases_application_id" ON "leases" ("application_id");

CREATE INDEX "leases_idx_property" ON "leases" ("property_id");

CREATE INDEX "leases_idx_tenant" ON "leases" ("tenant_id");

CREATE INDEX "leases_idx_status" ON "leases" ("status");

ALTER TABLE "maintenance_requests" ADD PRIMARY KEY ("id");

CREATE INDEX "maintenance_requests_tenant_id" ON "maintenance_requests" ("tenant_id");

CREATE INDEX "maintenance_requests_landlord_id" ON "maintenance_requests" ("landlord_id");

CREATE INDEX "maintenance_requests_idx_property" ON "maintenance_requests" ("property_id");

CREATE INDEX "maintenance_requests_idx_status" ON "maintenance_requests" ("status");

CREATE INDEX "maintenance_requests_idx_priority" ON "maintenance_requests" ("priority");

ALTER TABLE "messages" ADD PRIMARY KEY ("id");

CREATE INDEX "messages_property_id" ON "messages" ("property_id");

CREATE INDEX "messages_application_id" ON "messages" ("application_id");

CREATE INDEX "messages_idx_sender" ON "messages" ("sender_id");

CREATE INDEX "messages_idx_receiver" ON "messages" ("receiver_id");

CREATE INDEX "messages_idx_read" ON "messages" ("is_read");
...
CREATE UNIQUE INDEX "notification_settings_idx_user_notif" ON "notification_settings" ("user_id");

ALTER TABLE "payments" ADD PRIMARY KEY ("id");

CREATE UNIQUE INDEX "payments_payment_reference" ON "payments" ("payment_reference");

CREATE INDEX "payments_landlord_id" ON "payments" ("landlord_id");

CREATE INDEX "payments_property_id" ON "payments" ("property_id");

CREATE INDEX "payments_idx_lease" ON "payments" ("lease_id");

CREATE INDEX "payments_idx_tenant" ON "payments" ("tenant_id");

CREATE INDEX "payments_idx_status" ON "payments" ("status");

CREATE INDEX "payments_idx_due_date" ON "payments" ("due_date");

ALTER TABLE "payment_settings" ADD PRIMARY KEY ("id");

CREATE UNIQUE INDEX "payment_settings_idx_user_payment" ON "payment_settings" ("user_id");

ALTER TABLE "properties" ADD PRIMARY KEY ("id");

CREATE INDEX "properties_idx_landlord" ON "properties" ("landlord_id");

CREATE INDEX "properties_idx_status" ON "properties" ("status");

CREATE INDEX "properties_idx_city" ON "properties" ("city");

CREATE INDEX "properties_idx_rent" ON "properties" ("rent_amount");

CREATE INDEX "properties_idx_type" ON "properties" ("property_type");

ALTER TABLE "property_views" ADD PRIMARY KEY ("id");

CREATE INDEX "property_views_user_id" ON "property_views" ("user_id");

CREATE INDEX "property_views_idx_property" ON "property_views" ("property_id");

CREATE INDEX "property_views_idx_viewed_at" ON "property_views" ("viewed_at");
...
CREATE INDEX "sessions_idx_expires" ON "sessions" ("expires_at");

ALTER TABLE "tenant_profiles" ADD PRIMARY KEY ("id");

CREATE UNIQUE INDEX "tenant_profiles_unique_tenant_profile" ON "tenant_profiles" ("user_id");
...
CREATE UNIQUE INDEX "verifications_unique_user_verification" ON "verifications" ("user_id");

ALTER TABLE "notification_settings" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY;

ALTER TABLE "payment_settings" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY;
