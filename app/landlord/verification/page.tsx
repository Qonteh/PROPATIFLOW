...
import { ShieldCheck, CheckCircle, Loader2, AlertCircle, User, Mail, CreditCard, ArrowRight } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm max-w-sm mx-auto">
            Complete verification to unlock all landlord features and build trust with tenants
          </p>
        </div>
        ...
        {step === "nin" && (
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="text-center p-4">
              ...
              <p className="text-xs font-medium text-foreground">More Tenants</p>
              <p className="text-xs text-muted-foreground">Attract quality renters</p>
            </div>
          </div>
        )}
      </div>
